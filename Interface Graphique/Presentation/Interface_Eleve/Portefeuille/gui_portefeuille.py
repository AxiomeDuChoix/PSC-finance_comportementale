...
#        self.coeff_de_prop = np.dot(uns,np.dot(np.linalg.inv(self.Sigma),self.Mu)) # Coefficient de proportionalité entre gamma et 1/alpha
        ...
        self.indic_label.setMinimumSize(QtCore.QSize(450, 50))
        self.indic_label.setMaximumSize(QtCore.QSize(450, 50))
        self.indic_label.setObjectName("indic_label")
        self.VBoxG.addWidget(self.indic_label)
        self.gamma_label=QtWidgets.QLabel(self.VBoxGWidget)
        self.gamma_label.setWordWrap(True)
        self.gamma_label.setMinimumSize(QtCore.QSize(450, 50))
        self.gamma_label.setMaximumSize(QtCore.QSize(450, 50))
        self.gamma_label.setObjectName("gamma_label")
        self.VBoxG.addWidget(self.gamma_label)
        self.gamma=Parametres.aversion_au_risque
        self.numCourbe=Parametres.numeroExperience
        ...
        self.validerBouton.setGeometry(QtCore.QRect(130, 600, 200, 50))
...
#        self.exporterBouton.raise_()
        ...
        self.retourBouton.setGeometry(QtCore.QRect(20, 600, 200, 50))
        ...
        self.suivantBouton.setGeometry(QtCore.QRect(250, 600, 200, 50))
        self.suivantBouton.setObjectName("suivantBouton")
        self.suivantBouton.raise_()
    ...
    def retranslateUi(self, MainWindow,VAD_autorisee,retourBoutonUp):
        ...
        self.gamma_label.setText("Votre aversion au risque est de : "+str(self.gamma)+"\nLe numéro de l'expérience en cours est : "+str(self.numCourbe))
        if VAD_autorisee:
