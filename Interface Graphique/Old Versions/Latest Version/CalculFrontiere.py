...
def genererFrontiereDonnees(N,shortSellingEnabled):
    ...
    x,y=Moments(N)
    return genererFrontiere(x,y,shortSellingEnabled)

################################################################################
#AVEC RISK-FREE ET VAD
################################################################################
    
#A AJOUTER
    
################################################################################
#AVEC RISK-FREE SANS VAD
################################################################################
...
def convertirReturnsEnCours(N,prix_initial=100):
    ...
    prix_initiaux=[prix_initial for i in range(len(N))]
